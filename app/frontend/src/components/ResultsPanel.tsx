...
export default function ResultsPanel({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pricing/labor intentionally removed — takeoff-only app (Melvin 2026-06-23).
          Cost lives in a future per-trade pricing app; /cost-estimate endpoint kept dormant. */}
